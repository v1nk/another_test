const leadForm = {
  ...
  init: function(form){
    ...
    if (this.form.closest('.two-step-webform, .form-twostep')) {
      this.isTwoStep = true;
      this.hideElements(this.form.querySelector('.js-form-submit'));
    }
    ...
    this.nursingRadiosContainer = this.form.querySelector('div[data-drupal-selector="edit-registerednurse-validation-message-container"]');
    ...
    //We're on a two step and force showing is causing problems.
    if (this.form.closest('.js-show-fields-in-order')) {
  ...
  fixLabels: function() {
    ...
    if (!this.form.closest('.section--advisor-form-two-step')) {
      ...
      let label = this.tcpaContainer.querySelector('label');
      let span = this.tcpaContainer.querySelector('span');
      label.innerText = '';
      label.classList.remove('visually-hidden');
      this.tcpaContainer.appendChild(label);
      this.tcpaContainer.appendChild(span);
  ...
  handleDegreeChange: function() {
    this.handleNursing();
    this.college.dispatchEvent(new CustomEvent('selectGrayBackgroundTest'));
    this.degree.dispatchEvent(new CustomEvent('selectGrayBackgroundTest'));
  },
  ...
  handleNursing: function(){
    ...
    if (this.degree.value == '') {
      ...
      if (this.form.querySelector('[data-drupal-selector="edit-registerednurse"]')) {
        this.form.querySelector('[data-drupal-selector="edit-registerednurse"]').style.display = 'block';
      }
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  let forms = document.querySelectorAll('.webform-submission-lead-flow-system-form');
  ...
  forms.forEach(function(e, i, arr) {
    ...
    //Hook up the forms.
    let form = Object.assign({}, leadForm);
    form.init(e);
